...
class Model_Users extends RedBean_SimpleModel {
  ...
  function fields() {
    ...
    $fields['biography']  = array('type'=>'textarea', 'label'=>'biography', 'max_length'=>'255', 'help'=>'', 'table_hide'=>true);
    $fields['image']      = array('type'=>'file', 'label'=>'image', 'path'=>'img/people', 'help'=>'Profile image 200 x 200 px', 'table_hide'=>true);
