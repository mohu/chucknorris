...
class Model_Menuitem extends RedBean_SimpleModel {
  ...
  function fields() {
    // Add fields here
    $fields['title']      = array('type'=>'text', 'label'=>'title', 'help'=>'');
    $fields['link']       = array('type'=>'text', 'label'=>'link', 'help'=>'', 'readonly' => true);
    $fields['class']      = array('type'=>'text', 'label'=>'class', 'help'=>'Menu item class (to fire modals etc)', 'readonly' => true);
    $fields['ordering']    = array('type'=>'order', 'label'=>'ordering', 'required'=>true);
    $fields['published']  = array('type'=>'radio', 'label'=>'publish?', 'help'=>'', 'values'=>array('yes'=>1, 'no'=>0));
