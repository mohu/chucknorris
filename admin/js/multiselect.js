...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        quickElement('h6', selector_available, interpolate(gettext('Available %s'), [field_name]));
        var filter_p = quickElement('p', selector_available, '');
        filter_p.className = 'selector-filter';
        quickElement('i', filter_p, '', 'class', 'icon-search');
        ...
        quickElement('h6', selector_chosen, interpolate(gettext('Chosen %s'), [field_name]));
